...
class ilKSDocumentationExplorerGUI extends ilExplorerBaseGUI
{
     ...
     * @param ilObjStyleSettingsGUI  $a_parent_obj
     * @param $a_parent_cmd
     * @param Entry\ComponentEntries $entries
     * @param $current_opened_node_id
     */
    public function __construct(ilObjStyleSettingsGUI  $a_parent_obj, $a_parent_cmd, Entry\ComponentEntries $entries, $current_opened_node_id)
    {
