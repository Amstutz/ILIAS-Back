...
/**
 * Parses information from UI components. Main source are comments in the factories in YAML format.
 */
interface YamlParser {
    ...
    /**
     * Returns a list UI UI Component Entries of the parsed YAML entries in a given file.
     * @param string $filePath
